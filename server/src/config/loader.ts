...
export const DEFAULT_CONFIG: GameConfig = {
  ...
  handLimit: 5,
  maxRounds: null,
  ideologyMode: 'derived',  // Changed default to derived
  agendaBonus: 1,
  campaignCardsPerTurn: 1,
  seatTransferRule: 'player_choice',  // Changed default to player_choice
  proposalsPerRound: 1,
  ...
  negotiationTimeLimit: 0,  // 0 = unlimited, wait for all ready
